...
const { getAdminPage } = require('../handler/getAdminPage')
const { featurePermissionHandler } = require('../handler/featurePermissionHandler')
>>>>>>> c3e71d9f73deb1e3dcca240e17b24b075dd69b6f
...
router.get('/init-db-hehehx', async (req, res) => {
  try {
    ...
    INSERT INTO feature_permission (feature_id, permission_level) VALUES ('feature004', 29);  /* create dynamic form feature */
    INSERT INTO feature_permission (feature_id, permission_level) VALUES ('feature005', 1); /* post dynamic form feature */
    /*
